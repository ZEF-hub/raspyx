...
console.log(jsonData.monday.second)
...
function addPair(): void{
    ...
    pair.setAttribute('class', 'pair first')
    pair.innerHTML = `
                        <!--<div id="p-monday" class="day p-monday m-left mn-wdth">-->
                            <div class="date-time">
                                <div class="time">09:00 - 10:30</div>
                                <div class="date">01 сен - 24 дек</div>
                            </div>
                            <div class="rooms">
                                <div class="room">ПР1405</div>
                                <div class="room">ПР2405</div>
                            </div>
                            <div class="discipline">Проектная деятельность (Практика)</div>
                            <div class="teachers">
                                <div class="teacher">Малыхина Ксения Андреевна</div>
                                <div class="teacher">Малыхина Ксения Андреевна</div>
                            </div>
                        <!--</div>-->
                     `
    document.getElementById('p-monday')?.appendChild(pair);
}
